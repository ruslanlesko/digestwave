...
public class RSSFactory {
    ...
    public RSSFactory(ObjectMapper objectMapper, String configFilePath, HttpClient httpClient) {
    ...
    private RSSSite configToRSSSite(SiteConfig siteConfig) {
        ...
        return new RSSSite(uri, siteConfig.code(), httpClient, timeout, siteConfig.titleSuffixToTrim(), siteConfig.excludedCategories());
    }
