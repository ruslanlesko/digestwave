...
public class BusinessStandard extends RSSSite {
    private static final URI INDEX_URI = URI.create("https://www.business-standard.com/rss/finance-103.rss");

    public BusinessStandard(URI readabilityUri, HttpClient httpClient) {
        super(
                INDEX_URI,
                readabilityUri,
                "BS",
